...
<body>
    ...
    <div class="footer">
        <script>
            ...
            var targetHostname1 = 'mc.ecustvr.top';
            var targetHostname2 = 'mcinfo.cic.cab';
    
            if(currentHostname === targetHostname2) {
                document.write('<p>ECUST Computer Information Communication & VR Club<br/>');
                document.write('<a href="https://beian.miit.gov.cn/" target="_blank">沪ICP备2021021416号-2</a></p>');
            } else if(currentHostname === targetHostname1) {
                document.write('<p>ECUST Computer Information Communication & VR Club<br/>');
                document.write('<a href="https://beian.miit.gov.cn/" target="_blank">苏ICP备2023000758号-2</a> | <a class="nav-link" target="_blank" href="https://www.beian.gov.cn/portal/registerSystemInfo?recordcode=31012102000135" style="display:inline-block;text-decoration:none;height:20px;line-height:20px;"><img src="https://beian.mps.gov.cn/img/ghs.png" style="float:left;"/>沪公网安备31012102000135号</a></p>');
            }
        </script>
    </div>
</body>
